...
const imageGalleries = {
    "Lawn Care":[lawnCarePic, lawnCarePic, lawnCarePic],
    "Sod Work":[treeCutting, treeCutting],
    "Handyman Work":[handyMan,handyMan,handyMan],
    "Tractor Work":[tractor],
    "Pressure Washing":[pressureWash],
    "Mulch and Pine Straw":[misc,misc]
};
